...
- E1 스텝 스윕 (50→30/20/12 + guidance_rescale, 제출 없음) — **분담 제안 기안: [Y 인수, 목적=방법론·시간예산·v2 채점루프](15_E1_분담_제안.md). T 합의 대기** (선행: 홀드아웃 v2 → T 488 커밋)
- 홀드아웃 v2 생성 [Y 예정] — **절차 기안 완료: [14_홀드아웃_v2_절차.md](14_홀드아웃_v2_절차.md)** (선행: T가 488 목록을 `local_eval/holdout_t488.json`으로 커밋 — 초대 완료됐으니 직접 커밋 가능)
